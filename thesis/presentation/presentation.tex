...
%             \item Trwałe rekordy, funkcje wzajemnie rekurencyjne, algebraiczne typy danych, itp.
%         \end{itemize}
%     }
% \end{itemize}
% \end{frame}
...
% \begin{frame}{Co zostało wykonane?}
% \begin{itemize}
%     \item {
%         Jest wiele języków z rodziny ML
%         % \newline\newline
...
%             \item Zagnieżdżone funkcje 
%             \item Funkcje wyższych rzędów 
%             \item \sout{System modułów (OCaml, SML) lub obiektowe klasy (F\#)}
...
% \begin{frame}[fragile]{Co zostało wykonane?}
% \begin{itemize}
    % \item {
    %     Jest wiele języków z rodziny ML
...
% \begin{lstlisting}
% let twice (f : 'a -> 'a) (x : 'a) = f (f a)
% let _ =
%     print_float (twice (+.) 42.0);
%     print_int   (twice (+ ) 42  )

% \end{lstlisting}


%         \pause\newline$\rightarrow$ jednorodna 
%         reprezentacja danych 
%         \pause\newline$\rightarrow$ opakowywanie argumentów we wskaźnik 
%         }
%         \item Częściową aplikację 
%         \item Zagnieżdżone funkcje 
%         \item Funkcje wyższych rzędów 
