...
my implementation of a compiler for the functional programming language \textit{MonoML}, 
...
\begin{itemize}
  ...
  generowaniu kodu LLVM IR, bazowana na bibliotece \texttt{ollvm}\cite{ollvm}.
