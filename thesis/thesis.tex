...
Projekt można skompilować na systemie \textit{Linux}.
...
\begin{enumerate}
  ...
  \item Wymagana jest kompilator LLVM w wersji co najmniej $5$. Zainstalowaną 
...
\begin{itemize}
  ...
  \item \texttt{langc/} -- compiler executable
  \item \texttt{test/} -- tests for compiler and parser
