...
decyduję się zwiększenie rozmiaru wygenerowanego programu.
...
% $\rightarrow$ wywoływanie funkcji z api llvma $\rightarrow$ llc $\rightarrow$ gcc i 
sexternal) 
...
konieczności manualnego zarządzania stosem, co nie jest łatwe (o ile możliwe) w 
takich językach. Jednak moje rozwiązanie unika tego problemu, a ponadto
...
przykładowych programów, jednak mogło by znacznie wydłużyć czas kompilacji i 
...
% Moje rozwiązanie, choć z założenia szybsze i bardziej oszczędne w zasobach niż 
...
\begin{itemize}
  ...
  % \item \texttt{printer/} -- pretty-printer for abstract syntax tree
