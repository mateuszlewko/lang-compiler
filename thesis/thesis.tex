...
przestrzeń nazw dla logiczne związanych definicji. Nie są odpowiednikiem 
systemu modułów SMLa czy OCamla, które są dużo bardziej zaawansowane.
Moduł zawiera zawiera: wyrażenia let, zagnieżdżone moduły, import innych 
modułów oraz deklaracje funkcji zewnętrznych.
