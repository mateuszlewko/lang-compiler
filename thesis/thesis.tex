...
Rozdział 2 zawiera opis składni i semantyki języka MonoML oraz 
fragmenty przykładowych kodów. W rozdziale 3 w szczegółach
prezentuję, w jaki sposób zaimplementowałem najistotniejsze cechy języka.
W rozdziale 4 opisałem testowanie wydajności MonoMLa
na tle innych języków oraz pokazałem narzut czasowy opakowywania argumentów 
we wskaźnik. W rozdziale 5 zawarłem wnioski, które wysunąłem po zaimplementowaniu 
kompilatora i przeprowadzeniu testów wydajnościowych. Instrukcja obsługi 
wraz ze sposobem instalacji i potrzebnymi zależnościami znajduje się w rozdziale 6.
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Dzięki przeprowadzeniu inferencji typów, nadaje każdemu wyrażeniu 
    jego typ z języka MonoML (na późniejszym etapie, wyrażenia będą miał typ 
    z LLVM IR). 
