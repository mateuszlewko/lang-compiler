...
wywodzących się z \textit{SMLa}, takich jak \textit{OCaml} i \textit{F\#}. W swojej 
pracy zaimplementowałem kompilator języka funkcyjnego \textit{Lang}, 
...
Ponadto wprowadziłem do niego typy klas zamiast skomplikowanego systemu 
modułów. Porównam swoje rozwiązania z innymi rozwiązaniami i omówię kompromisy na które się zdecydowałem.
