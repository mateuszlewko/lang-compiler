...
Analiza wcięć w $Langu$ jest zbliżona do tej w $Pythonie$. Dla każdego wiersza, 
...
Wskaźnik na funkcje $fn$, przed wywołaniem musi zostać zrzutowany 
